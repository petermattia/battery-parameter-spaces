...
for k, batch_idx in enumerate(batches_to_plot):
    ...
    ax.set_xlabel('CC1',fontsize=fs, labelpad=12), ax.set_xlim([3, 8])
    ax.set_ylabel('CC2',fontsize=fs, labelpad=12), ax.set_ylim([3, 8])
    ax.set_zlabel('CC3',fontsize=fs, labelpad=12), ax.set_zlim([3, 8])
...
plt.savefig('plots/evolution_poster.png')
plt.savefig('plots/evolution_poster.pdf')