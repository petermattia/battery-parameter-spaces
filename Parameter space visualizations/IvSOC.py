...
ax.plot([0,20], [c1,c1], linewidth=2, color='red')
ax.plot([20,40],[c2,c2], linewidth=2, color='red')
ax.plot([40,60],[c3,c3], linewidth=2, color='red')
ax.plot([60,80],[c4,c4], linewidth=2, color='blue')
