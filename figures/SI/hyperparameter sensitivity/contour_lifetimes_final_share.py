...
## SAVE
if CROPPED_BOUNDS:
    plt.savefig('final_bounds_sharexy.png', bbox_inches = 'tight')
    plt.savefig('final_bounds_sharexy.pdf', bbox_inches = 'tight',format='pdf')
else:
    plt.savefig('final_bounds_full_sharexy.png', bbox_inches = 'tight')
    plt.savefig('final_bounds_full_sharexy.pdf', bbox_inches = 'tight',format='pdf')