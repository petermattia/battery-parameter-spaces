...
print('total expected cmds', len(list(itertools.combinations(policy_list, num_train_policies)))*num_seeds*len(list(itertools.product(beta_list, gamma_list, epsilon_list)))*num_rounds)
