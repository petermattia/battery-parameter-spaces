...
def read_data():
	...
	data = np.genfromtxt('data/batch2.csv',
			delimiter=',', skip_header=1)

	X_obs = data[:,:-1] # design matrix 
					# (N x d where N: number of historical evals and d: dimensions of search space)
	Y_obs = data[:,-1] # noisy function evaluations (vector)
