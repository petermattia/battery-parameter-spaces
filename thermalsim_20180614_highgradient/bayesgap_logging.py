...
import argparse
import os
from thermalsim_highgradient import thermalsim
from contour_animate import animate
...
def parse_args():
	...
	parser.add_argument('--prior_std', default=1000, type=float,
