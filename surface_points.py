...
def plot_surface(C1, C2, C3, C4_LIMITS, filename):
    ...
    ## SAVE FIGURE
    plt.savefig('surface_' + filename + '.png', bbox_inches='tight')
    plt.savefig('surface_' + filename + '.pdf', bbox_inches='tight', format='pdf')
