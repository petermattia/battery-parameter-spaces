...
##############################################################################
hp_list = [0.1,0.2,0.5,1,2,5,10,20,30,40,50,55,60,65,70,80,90,100] # Smoothing parameter
...
for k, hp in enumerate(hp_list):
    ...
    for k2, (train_index, test_index) in enumerate(kf.split(data[:,0:3])):
        ...
        # CREATE RBF
        rbf = Rbf(X_train[:,0], X_train[:,1], X_train[:,2],y_train,
                  function='thin_plate',smooth=hp)
